...
- Check out the [interviews](interviews.md) section for advice on how to pass analytics engineering interviews!
- Check out the [books](books.md) section for a list of high quality analytics engineering books
- Check out the [communities](communities.md) section for a list of high quality analytics engineering communities to join
- Check out the [newsletters](newsletters.md) section to learn via email


## Resources

### Great [list of over 20 books](books.md)
...
- Transformation & Modeling
  ...
  - [Dataform (Google)](https://dataform.co/)
...
- Semantic / Metrics Layers
  - [dbt Semantic Layer (MetricFlow)](https://www.getdbt.com/product/semantic-layer)
  - [Cube](https://cube.dev)
  - [Lightdash](https://lightdash.com/)
  - [Transform (acquired by dbt Labs)](https://transform.co/)
- Analytics / Visualization
  - [Looker (Google)](https://looker.com/)
  - [Tableau](https://www.tableau.com/)
  - [Power BI](https://powerbi.microsoft.com/)
  - [Preset / Apache Superset](https://www.preset.io)
...
### Analytics Engineering Blogs:

- [dbt Developer Blog](https://docs.getdbt.com/blog)
- [Locally Optimistic](https://locallyoptimistic.com/)
- [Benn Stancil's Blog](https://benn.substack.com/)
- [Netflix Data Blog](https://netflixtechblog.com/tagged/big-data)
- [Airbnb Data Blog](https://medium.com/airbnb-engineering/data/home)
- [Spotify Engineering (Data)](https://engineering.atspotify.com/category/data/)
- [Uber Data Blog](https://www.uber.com/blog/houston/data/)
- [GitLab Data Team Handbook](https://about.gitlab.com/handbook/business-technology/data-team/)
- [Brooklyn Data Co. Blog](https://brooklyndata.co/blog)
- [Databricks Blog](https://www.databricks.com/blog/category/engineering/data-engineering)
- [Snowflake Blog](https://www.snowflake.com/blog/)
- [The Data Warehouse Insiders](https://www.kimballgroup.com/category/data-warehouse-and-business-intelligence/)
- [Simon Späti's Data Blog](https://www.ssp.sh/blog/)
- [Start Data Engineering](https://www.startdataengineering.com/)
- [Preset Blog](https://preset.io/blog/)
- [Hex Blog](https://hex.tech/blog/)

### Analytics Engineering Papers & Whitepapers:
...
- [Data Engineering Whitepapers Collection](https://www.ssp.sh/brain/data-engineering-whitepapers/)
- [The Metrics Layer by dbt Labs](https://docs.getdbt.com/docs/build/metrics-overview)
- [Building a Mature Analytics Workflow](https://docs.getdbt.com/blog/building-a-mature-analytics-workflow)
...
| Benn Stancil             | [Benn Stancil](https://www.linkedin.com/in/benn-stancil/)                                                | 30,000+        |
| Claire Carroll           | [Claire Carroll](https://www.linkedin.com/in/clairervcarroll/)                                           | 20,000+        |
| Seattle Data Guy         | [Ben Rogojan](https://www.linkedin.com/in/benjaminrogojan)                                               | 100,000+       |
| Tristan Handy            | [Tristan Handy](https://www.linkedin.com/in/tristanhandy/)                                              | 50,000+        |
| Emilie Schario           | [Emilie Schario](https://www.linkedin.com/in/emilieschario/)                                             | 10,000+        |
...
| Anna Filippova           | [Anna Filippova](https://www.linkedin.com/in/annafilippova/)                                             | 10,000+        |
...
|-------------------|------------------------------------------------------------------|---------------:|
| Tristan Handy     | [@jthandy](https://twitter.com/jthandy)                          | 30,000+        |
| Benn Stancil      | [@bennstancil](https://twitter.com/bennstancil)                  | 20,000+        |
...
| Claire Carroll    | [@claborjaires](https://twitter.com/claborjaires)                | 10,000+        |
| dbt Labs          | [@daborbt_labs](https://twitter.com/dbt_labs)                    | 50,000+        |
| Emilie Schario    | [@emaborilieschario](https://twitter.com/emilieschario)          | 10,000+        |
...
- [The Data Chief by ThoughtSpot](https://www.thoughtspot.com/data-chief/podcast)
...
### Glossaries:
- [dbt Glossary](https://docs.getdbt.com/terms/elt)
...
- [dbt Style Guide by dbt Labs](https://github.com/dbt-labs/corp/blob/main/dbt_style_guide.md)
...
- [Data Developer Platform Architecture](https://datadeveloperplatform.org/architecture/)
- [Medallion Architecture by Databricks](https://www.databricks.com/glossary/medallion-architecture)
- [The Metrics Layer Explained](https://docs.getdbt.com/docs/build/metrics-overview)

### Courses / Academies

- [DataExpert.io course](https://www.dataexpert.io) use code **HANDBOOK10** for a discount!
- [dbt Learn (dbt Fundamentals)](https://learn.getdbt.com/) — Free official dbt course
- [Technical Freelancer Academy](https://www.technicalfreelanceracademy.com/) Use code **zwtech** for a discount!
- [Analytics Engineering with dbt (Coursera)](https://www.coursera.org/learn/analytics-engineering-with-dbt)
- [The Complete dbt Bootcamp (Udemy)](https://www.udemy.com/course/complete-dbt-data-build-tool-bootcamp-zero-to-hero/)
- [DataCamp](https://www.datacamp.com/)
- [LearnDataEngineering.com](https://www.learndataengineering.com)
...
- [Rock the JVM](https://rockthejvm.com/) — Teaches Spark, Flink, and more
...
- [Snowflake SnowPro Core Certification](https://learn.snowflake.com/en/certifications/snowpro-core/)
- [Snowflake SnowPro Advanced: Data Engineer](https://learn.snowflake.com/en/certifications/snowpro-advanced-data-engineer/)
- [Databricks - Data Engineer Associate](https://www.databricks.com/learn/certification/data-engineer-associate)
- [Microsoft DP-203: Data Engineering on Microsoft Azure](https://learn.microsoft.com/en-us/credentials/certifications/exams/dp-203/)
...
- [Google Looker Business Analyst Certificate](https://cloud.google.com/looker/docs/looker-certification)
